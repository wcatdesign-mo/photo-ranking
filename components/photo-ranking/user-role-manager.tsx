...
export default function UserRoleManager({
  ...
  return (
    <div className="mt-8 overflow-hidden rounded-xl border">
      <div className="grid grid-cols-[1fr_180px_180px] border-b px-5 py-4 text-sm font-semibold text-muted-foreground">
        <div>Felhasználó</div>
      ...
      {users.length === 0 ? (
        ...
        users.map((user) => (
          <div
            key={user.id}
            className="grid grid-cols-[1fr_180px_180px] items-center border-b px-5 py-4 last:border-b-0"
          >
            <div>
